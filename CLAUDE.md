...
| `index3.html` | **프로젝트팀 관리 시스템** (v1.3) | 명단 업로드 → 팀 배정 → 팀원 상호평가 → 결과 집계 | 2,859줄 | Apps Script `Code.gs` | [docs/03-프로젝트팀관리.md](docs/03-프로젝트팀관리.md) |
...
| 앱 | 현재 | 표시 위치 |
|---|---|---|
| `index3.html` 프로젝트팀 관리 | **v1.3** | 상단 배지(`verBadge`) + 푸터(`verFooter`) |
